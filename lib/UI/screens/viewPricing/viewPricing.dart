...
class ViewPricing extends StatelessWidget {
  final List<Tab> myTabs = <Tab>[
    Tab(
      child: Text('NATIVES', style: TextStyle(
      fontWeight: FontWeight.normal, fontSize: 16),),
    ),
    Tab(
      child: Text('TOPS', style: TextStyle(
      fontWeight: FontWeight.normal, fontSize: 16),),
    ),
    Tab(
      child: Text('BOTTOMS', style: TextStyle(
      fontWeight: FontWeight.normal, fontSize: 16),),
    ),
    Tab(
      ...
      Tab(
      child: Text('505', style: TextStyle(
      fontWeight: FontWeight.normal, fontSize: 16),),
    ),
         ...
         leading: Row(
           children: [
             ...
             Icon(Icons.arrow_back_ios),
              SizedBox(width: 5,),
             Text('Back', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w300, fontSize: 15),)
           ],
         ),
        bottom: TabBar(
         unselectedLabelColor: Color(0xff999999),
                  ...
                  indicatorWeight: 3, labelColor: Color(0xff135A59),
